...
\input{Chapters/11-Multiset Rewriting and P Systems}
\input{Chapters/13-Petri Nets}
\input{Chapters/14-Applications of Petri Nets in Manufacturing}
\input{Chapters/15-Discrete-Event Simulation}
\input{Chapters/16-Cellular Automata}
\nocite{*}
